...
def sync_vid_imu(vid_pIds, vid_frames, vid_labels, vid_probs, imu_pIds, imu_frames, imu_labels, imu_probs, imu_labels1, imu_labels2, imu_labels3, imu_labels4):
...
def read_vid_imu_prob_file(filenamepath):
    ...
    with open(filenamepath) as prob_file:
        for row in csv.reader(prob_file, delimiter=','):
            ...
            imu_pIds.append(row[4])
            imu_frames.append(row[5])
            imu_labels.append(row[6])
            imu_probs.append(row[7])
...
def write_vid_imu_prob_file(vid_pIds, vid_frames, vid_labels, vid_probs, imu_pIds, imu_frames, imu_labels, imu_probs, imu_labels1, imu_labels2, imu_labels3, imu_labels4, vid_imu_filenamepath):
...
def merge_vid_imu_prob_file(vid_filenamepath, imu_filenamepath, vid_imu_filenamepath):
    vid_pIds, vid_frames, vid_labels, vid_probs = read_vid_prob_file(vid_filenamepath)
    imu_pIds, imu_frames, imu_labels, imu_probs, imu_labels1, imu_labels2, imu_labels3, imu_labels4 = read_imu_prob_file(imu_filenamepath)
    vid_pIds, vid_frames, vid_labels, vid_probs, imu_pIds, imu_frames, imu_labels, imu_probs, imu_labels1, imu_labels2, imu_labels3, imu_labels4 = \
        sync_vid_imu(vid_pIds, vid_frames, vid_labels, vid_probs, imu_pIds, imu_frames, imu_labels, imu_probs, imu_labels1, imu_labels2, imu_labels3, imu_labels4)
    write_vid_imu_prob_file(vid_pIds, vid_frames, vid_labels, vid_probs, imu_pIds, imu_frames, imu_labels, imu_probs, imu_labels1, imu_labels2, imu_labels3, imu_labels4, vid_imu_filenamepath)


def merge_vid_imu_prob_files(vid_prob_dir, imu_prob_dir, vid_imu_prob_merge_dir):
    ...
    for vid_prob_filename in vid_prob_filenames:
        ...
        if '1067' in vid_prob_filename_withoutpath or '1020' in vid_prob_filename_withoutpath:
            continue
        imu_prob_filename = os.path.join(imu_prob_dir, vid_prob_filename_withoutpath)
        assert utils.is_file(imu_prob_filename),"fine {0} does not exist".format(imu_prob_filename)
        ...
        if utils.is_file(vid_imu_prob_filename):
            continue
        merge_vid_imu_prob_file(vid_prob_filename, imu_prob_filename, vid_imu_prob_filename)
